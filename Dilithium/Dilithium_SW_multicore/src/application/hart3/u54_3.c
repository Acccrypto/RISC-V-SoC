...
void u54_3(void)
{
    ...
    rej:
        ...
        polyw1_pack(&hart_share->sm[5*POLYW1_PACKEDBYTES+CRHBYTES], &hart_share->w1.vec[5]);
        ...
        polyw1_pack(&hart_share->pw1_buf[5*POLYW1_PACKEDBYTES + CRHBYTES], &hart_share->w1.vec[5]);
