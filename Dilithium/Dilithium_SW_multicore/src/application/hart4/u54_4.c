...
void u54_4(void)
{
    ...
    rej:
        ...
        polyw1_pack(&hart_share->sm[6*POLYW1_PACKEDBYTES+CRHBYTES], &hart_share->w1.vec[6]);
        poly_decompose(&hart_share->w1.vec[7], &hart_share->w0.vec[7], &hart_share->w1.vec[7]);
        polyw1_pack(&hart_share->sm[7*POLYW1_PACKEDBYTES+CRHBYTES], &hart_share->w1.vec[7]);
        ...
        polyw1_pack(&hart_share->pw1_buf[6*POLYW1_PACKEDBYTES + CRHBYTES], &hart_share->w1.vec[6]);
        poly_use_hint(&hart_share->w1.vec[7], &hart_share->w1.vec[7], &hart_share->h.vec[7]);
        polyw1_pack(&hart_share->pw1_buf[7*POLYW1_PACKEDBYTES + CRHBYTES], &hart_share->w1.vec[7]);
