...
set_partition_info -name "/MPFS_ICICLE_KIT_BASE_DESIGN" -timestamp "1700991518"
set_partition_info -name "/MPFS_ICICLE_KIT_BASE_DESIGN/FIC_0_PERIPHERALS_1/Core_Poly_0" -timestamp "1704529018"
...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"E:\MPFS_Projects\Kyber_HW\synthesis\MPFS_ICICLE_KIT_BASE_DESIGN.vm"}
set_compile_info \
    -category {"Options"} \
    -name {"Limit the number of high fanout nets to display to"} \
    -value {"10"}
compile \
    -desdir {E:\MPFS_Projects\Kyber_HW\designer\MPFS_ICICLE_KIT_BASE_DESIGN} \
    -design MPFS_ICICLE_KIT_BASE_DESIGN \
    -fam PolarFireSoC \
    -die PA5SOC250T_ES \
    -pkg fcvg484 \
    -partition_pdc_file {E:\MPFS_Projects\Kyber_HW\designer\MPFS_ICICLE_KIT_BASE_DESIGN\MPFS_ICICLE_KIT_BASE_DESIGN.nmatinit.pdc} \
    -merge_pdc 0
