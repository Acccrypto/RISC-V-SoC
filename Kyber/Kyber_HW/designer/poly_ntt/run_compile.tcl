...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"F:\RISC-V\Reference Code\icicle-kit-reference-design-master\MPFS_ICICLE\synthesis\poly_ntt.vm"}
set_compile_info \
    -category {"Options"} \
    -name {"Limit the number of high fanout nets to display to"} \
    -value {"10"}
compile \
    -desdir {F:\RISC-V\Reference Code\icicle-kit-reference-design-master\MPFS_ICICLE\designer\poly_ntt} \
    -design poly_ntt \
    -fam PolarFireSoC \
    -die PA5SOC250T_ES \
    -pkg fcvg484 \
